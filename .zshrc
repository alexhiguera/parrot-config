...
# my_alias
alias foto="kitty +kitten icat"
alias gato="gcc -Wall -Werror -Wextra -o pipo"
alias fondo="feh --bg-fill Desktop/columbux/Fondos/casa-kame-de-dragon-ball-4k.jpg"
alias cat=batcat
alias bsp="nano /home/columbux/.config/bspwm/bspwmrc"

	# polybar targets
alias pon="settarget"
alias limpia="cleartarget"
...
#source /home/columbux/powerlevel10k/powerlevel10k.zsh-theme
...
# ZSH syntax Autocomplete Plugin
#if [ -f /usr/share/zsh-autocomplete/zsh-autocomplete.plugin.zsh ]; then
#    source /usr/share/zsh-autocomplete/zsh-autocomplete.plugin.zsh
#fi

# Agrega esta línea para suprimir la advertencia
...
# PATH
export PATH=/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/sbin/:/opt/nvim/nvim-linux64/bin
...
function settarget(){
    ip_address=$1
    machine_name=$2
    echo "$ip_address $machine_name" > /home/columbux/.config/bin/target
}

# clear victim target
function cleartarget(){
    echo '' > /home/columbux/.config/bin/target
}
